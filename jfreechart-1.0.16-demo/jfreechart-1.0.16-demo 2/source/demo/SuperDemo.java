...
public class SuperDemo extends ApplicationFrame
    ...
    private JMenuBar createMenuBar() {
        ...
        JMenuItem exportToCanvas = new JMenuItem("Export to Canvas...", 'j');
        exportToCanvas.setActionCommand("EXPORT_TO_CANVAS");
        exportToCanvas.addActionListener(this);
        fileMenu.add(exportToCanvas);

        JMenuItem exportToSVG = new JMenuItem("Export to SVG...", 'j');
        exportToSVG.setActionCommand("EXPORT_TO_SVG");
        exportToSVG.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        else if (command.equals("EXPORT_TO_CANVAS")) {
            exportToCanvas();
        }
        ...
        if (chart != null) {
            ...
            if (result == JFileChooser.APPROVE_OPTION) {
                try {
                    ...
                    CanvasExportTask t = new CanvasExportTask(chartClone, w, h,
                            fc.getSelectedFile());
    ...
    /**
     * Saves a chart to a file in PDF format using JFreeGraphics2D.
     *
     * @param file  the file.
     * @param chart  the chart.
...
//        root.add(createExperimentalNode());
    ...
    private MutableTreeNode createShowcaseNode(DefaultMutableTreeNode r) {
        DefaultMutableTreeNode root = new DefaultMutableTreeNode(
                "*** Showcase Charts ***");
        MutableTreeNode defaultNode = createNode("demo.BarChart3DDemo1", "BarChart3DDemo1.java");
        ...
        root.add(createNode("demo.TimeSeriesDemo14", "TimeSeriesDemo14.java"));
    ...
    public static void main(String[] args) {
        ...
        // here we enable the shadow generator that was introduced in
        // version 1.0.14 - it is not enabled by default for reasons of
        // backwards compatibility
        ChartFactory.setChartTheme(new StandardChartTheme("JFree/Shadow",
                true));
        SuperDemo demo = new SuperDemo("JFreeChart 1.0.16 Demo Collection");
        demo.pack();
