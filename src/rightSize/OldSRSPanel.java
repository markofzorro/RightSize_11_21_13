...
public class OldSRSPanel extends JPanel 
{
...
*/
	...
	public OldSRSPanel() {
		...
		tfN = new JTextField();
		tfN.setHorizontalAlignment(SwingConstants.TRAILING);
		tfN.setFont(new Font("Lucida Grande", Font.PLAIN, 24));
		tfN.setColumns(10);
		GridBagConstraints gbc_tfN = new GridBagConstraints();
		gbc_tfN.anchor = GridBagConstraints.NORTH;
		gbc_tfN.fill = GridBagConstraints.HORIZONTAL;
		gbc_tfN.insets = new Insets(0, 0, 5, 5);
		gbc_tfN.gridx = 4;
		gbc_tfN.gridy = 7;
		add(tfN, gbc_tfN);
